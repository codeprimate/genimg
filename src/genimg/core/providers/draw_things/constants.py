...
def default_root_ca_pem_path() -> Path:
    ...
    root = pkg_resources.files("genimg.core.providers.draw_things.vendor")
...
MSG_FPZIP_IMPORT: str = (
    ...
    "Install with: pip install fpzip."
)
...
MSG_PROVIDER_DECODE_NOT_IMPLEMENTED: str = (
    f"{ERR_PREFIX_API} Tensor decode not available; ensure numpy and fpzip are installed."
)
